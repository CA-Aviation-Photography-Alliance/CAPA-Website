...
const sampleEvents = [
  ...
  },
  {
    ...
    description: 'Join us for the biggest technology conference of the year featuring keynotes, workshops, and networking opportunities with industry leaders.',
    creator: 'Tech Events Inc'
  },
  {
    startdate: new Date(Date.now() + 21 * 24 * 60 * 60 * 1000), // 3 weeks from now
    enddate: new Date(Date.now() + 21 * 24 * 60 * 60 * 1000 + 1 * 60 * 60 * 1000), // 1 hour later
    type: 'meeting',
    title: 'Team Planning Session',
    description: 'Monthly team planning and review meeting to discuss project progress, upcoming milestones, and resource allocation.',
  ...
  },
  {
    ...
    description: 'Explore the basics of data science including statistics, machine learning, and data visualization techniques.',
    creator: 'Data Science Institute'
  },
  {
    startdate: new Date(Date.now() + 28 * 24 * 60 * 60 * 1000), // 4 weeks from now
    enddate: new Date(Date.now() + 28 * 24 * 60 * 60 * 1000 + 8 * 60 * 60 * 1000), // 8 hours later
    type: 'hackathon',
    title: 'Innovation Hackathon 2024',
    description: '24-hour hackathon focused on creating innovative solutions for sustainability and climate change challenges.',
    creator: 'Innovation Hub'
  },
  {
    startdate: new Date(Date.now() + 5 * 24 * 60 * 60 * 1000), // 5 days from now
    enddate: new Date(Date.now() + 5 * 24 * 60 * 60 * 1000 + 1.5 * 60 * 60 * 1000), // 1.5 hours later
    type: 'webinar',
    title: 'Remote Work Best Practices',
    description: 'Learn effective strategies for remote work, time management, and maintaining work-life balance in a distributed team environment.',
    creator: 'Remote Work Experts'
  },
  {
    startdate: new Date(Date.now() + 35 * 24 * 60 * 60 * 1000), // 5 weeks from now
    enddate: new Date(Date.now() + 35 * 24 * 60 * 60 * 1000 + 4 * 60 * 60 * 1000), // 4 hours later
    type: 'training',
  ...
  },
  {
    ...
    enddate: new Date(Date.now() + 12 * 24 * 60 * 60 * 1000 + 2 * 60 * 60 * 1000), // 2 hours later
    type: 'networking',
    title: 'Tech Professionals Networking Event',
    description: 'Connect with fellow technology professionals, share experiences, and build meaningful professional relationships.',
    creator: 'Tech Networking Group'
  },
  {
    startdate: new Date(Date.now() + 42 * 24 * 60 * 60 * 1000), // 6 weeks from now
    enddate: new Date(Date.now() + 42 * 24 * 60 * 60 * 1000 + 3 * 60 * 60 * 1000), // 3 hours later
    type: 'panel',
    title: 'Women in Tech Panel Discussion',
    description: 'Panel discussion featuring successful women leaders in technology sharing their experiences and insights.',
    creator: 'Women in Tech Organization'
  },
  {
    startdate: new Date(Date.now() + 3 * 24 * 60 * 60 * 1000), // 3 days from now
    enddate: new Date(Date.now() + 3 * 24 * 60 * 60 * 1000 + 1 * 60 * 60 * 1000), // 1 hour later
    type: 'standup',
    title: 'Weekly Team Standup',
    description: 'Regular weekly standup meeting to discuss progress, blockers, and upcoming work for the development team.',
...
async function createTestData() {
  try {
    ...
    if (existingCount > 0) {
      ...
      console.log('❓ Do you want to clear existing data and create fresh sample data?');
    ...
    console.log('3. View events: curl http://localhost:3001/api/simple-events');
    console.log('4. View upcoming: curl http://localhost:3001/api/simple-events/upcoming');
