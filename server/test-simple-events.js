...
const testEvent = {
  ...
  description:
    "This is a test event created by the API test script to verify functionality",
...
async function main() {
  ...
  console.log("Make sure the server is running on http://localhost:3003\n");
...
async function checkServer() {
  try {
    ...
    console.log(
      "❌ Cannot reach server. Please make sure the server is running on http://localhost:3003\n",
    );
